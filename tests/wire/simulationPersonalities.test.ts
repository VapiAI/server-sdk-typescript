...
describe("SimulationPersonalitiesClient", () => {
    test("PersonalityController_findAll", async () => {
        ...
        const response = await client.simulationPersonalities.personalityControllerFindAll();
    ...
    test("PersonalityController_create", async () => {
        const server = mockServerPool.createServer();
        const client = new VapiClient({ maxRetries: 0, token: "test", environment: server.baseUrl });
        const rawRequestBody = { name: "name", assistant: {} };
        const rawResponseBody = {
            id: "id",
            orgId: "orgId",
            createdAt: "2024-01-15T09:30:00Z",
        ...
        server
            .mockEndpoint()
            .post("/eval/simulation/personality")
        ...
        const response = await client.simulationPersonalities.personalityControllerCreate({
            name: "name",
            assistant: {},
        });
        expect(response).toEqual({
    ...
    test("PersonalityController_findOne", async () => {
        const server = mockServerPool.createServer();
        const client = new VapiClient({ maxRetries: 0, token: "test", environment: server.baseUrl });
        ...
        const response = await client.simulationPersonalities.personalityControllerFindOne({
            id: "id",
        });
        expect(response).toEqual({
            id: "id",
    ...
    test("PersonalityController_remove (1)", async () => {
        const server = mockServerPool.createServer();
        const client = new VapiClient({ maxRetries: 0, token: "test", environment: server.baseUrl });
        ...
        const response = await client.simulationPersonalities.personalityControllerRemove({
            id: "id",
        });
        expect(response).toEqual({
            id: "id",
    ...
    test("PersonalityController_remove (2)", async () => {
        const server = mockServerPool.createServer();
        const client = new VapiClient({ maxRetries: 0, token: "test", environment: server.baseUrl });
        ...
        await expect(async () => {
            return await client.simulationPersonalities.personalityControllerRemove({
                id: "id",
            });
        }).rejects.toThrow(Vapi.ConflictError);
    });

    test("PersonalityController_update", async () => {
        const server = mockServerPool.createServer();
        const client = new VapiClient({ maxRetries: 0, token: "test", environment: server.baseUrl });
        ...
        const response = await client.simulationPersonalities.personalityControllerUpdate({
            id: "id",
        });
        expect(response).toEqual({
            id: "id",
