...
describe("CallsClient", () => {
        ...
        const rawResponseBody = [
            {
                ...
                artifact: {
                    messages: [{ role: "role", message: "message", time: 1.1, endTime: 1.1, secondsFromStart: 1.1 }],
                    messagesOpenAIFormatted: [{ content: null, role: "assistant" }],
                    ...
                    scorecards: { key: "value" },
                    transfers: ["transfers"],
                    structuredOutputsLastUpdatedAt: "2024-01-15T09:30:00Z",
                },
        ...
        const rawResponseBody = {
            ...
            artifact: {
                ...
                performanceMetrics: {
                    ...
                    fromTransportLatencyAverage: 1.1,
                    toTransportLatencyAverage: 1.1,
                    numUserInterrupted: 1.1,
                    numAssistantInterrupted: 1.1,
                },
                structuredOutputs: { key: "value" },
                scorecards: { key: "value" },
                transfers: ["transfers"],
    ...
    test("delete", async () => {
        ...
        const response = await client.calls.delete({
            id: "id",
        });
        expect(response).toEqual({
            type: "inboundPhoneCall",
    ...
    test("update", async () => {
        ...
        const response = await client.calls.update({
            id: "id",
        });
        expect(response).toEqual({
            type: "inboundPhoneCall",
