...
describe("AssistantsClient", () => {
    ...
    test("create", async () => {
        ...
        const rawResponseBody = {
            ...
            credentials: [{ provider: "11labs", apiKey: "apiKey", apiUrl: "https://api.elevenlabs.io", name: "name" }],
            hooks: [
                {
                    on: "call.ending",
                    do: [
    ...
    test("delete (2)", async () => {
        ...
        server.mockEndpoint().delete("/assistant/id").respondWith().statusCode(409).jsonBody(rawResponseBody).build();

        await expect(async () => {
            return await client.assistants.delete({
                id: "id",
            });
