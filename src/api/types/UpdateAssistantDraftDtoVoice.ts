 ...
 */
export type UpdateAssistantDraftDtoVoice =
    | Vapi.UpdateAssistantDraftDtoVoice.Azure
    | Vapi.UpdateAssistantDraftDtoVoice.Cartesia
    | Vapi.UpdateAssistantDraftDtoVoice.CustomVoice
    | Vapi.UpdateAssistantDraftDtoVoice.Deepgram
    | Vapi.UpdateAssistantDraftDtoVoice._11Labs
    | Vapi.UpdateAssistantDraftDtoVoice.Hume
    | Vapi.UpdateAssistantDraftDtoVoice.Lmnt
    | Vapi.UpdateAssistantDraftDtoVoice.Neuphonic
    | Vapi.UpdateAssistantDraftDtoVoice.Openai
    | Vapi.UpdateAssistantDraftDtoVoice.Playht
    | Vapi.UpdateAssistantDraftDtoVoice.Wellsaid
    | Vapi.UpdateAssistantDraftDtoVoice.RimeAi
    | Vapi.UpdateAssistantDraftDtoVoice.SmallestAi
    | Vapi.UpdateAssistantDraftDtoVoice.Tavus
    | Vapi.UpdateAssistantDraftDtoVoice.Vapi
    | Vapi.UpdateAssistantDraftDtoVoice.Sesame
    | Vapi.UpdateAssistantDraftDtoVoice.Inworld
    | Vapi.UpdateAssistantDraftDtoVoice.Minimax
    | Vapi.UpdateAssistantDraftDtoVoice.Xai
    | Vapi.UpdateAssistantDraftDtoVoice.Microsoft;

export namespace UpdateAssistantDraftDtoVoice {
