...
export const FallbackAzureSpeechTranscriberLanguage = {
    AfZa: "af-ZA",
    AmEt: "am-ET",
    ArAe: "ar-AE",
    ArBh: "ar-BH",
...
export type FallbackAzureSpeechTranscriberLanguage =
    (typeof FallbackAzureSpeechTranscriberLanguage)[keyof typeof FallbackAzureSpeechTranscriberLanguage];
