 ...
 */
export const LineInsightFromCallTableGroupBy = {
...
export type LineInsightFromCallTableGroupBy =
    (typeof LineInsightFromCallTableGroupBy)[keyof typeof LineInsightFromCallTableGroupBy];
