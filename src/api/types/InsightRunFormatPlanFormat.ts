 ...
 */
export const InsightRunFormatPlanFormat = {
    Raw: "raw",
    Recharts: "recharts",
} as const;
export type InsightRunFormatPlanFormat = (typeof InsightRunFormatPlanFormat)[keyof typeof InsightRunFormatPlanFormat];
