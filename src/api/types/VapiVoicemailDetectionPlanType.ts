 ...
 */
export const VapiVoicemailDetectionPlanType = {
    Audio: "audio",
    Transcript: "transcript",
} as const;
export type VapiVoicemailDetectionPlanType =
    (typeof VapiVoicemailDetectionPlanType)[keyof typeof VapiVoicemailDetectionPlanType];
