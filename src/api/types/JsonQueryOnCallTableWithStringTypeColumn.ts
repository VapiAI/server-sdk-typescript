...
export interface JsonQueryOnCallTableWithStringTypeColumn {
    ...
    table: Vapi.JsonQueryOnCallTableWithStringTypeColumnTable;
    /**
     ...
     */
    column: Vapi.JsonQueryOnCallTableWithStringTypeColumnColumn;
    /**
     * This is the aggregation operation to perform on the column.
     * When the column is a string type, the operation must be "count".
     */
    operation: Vapi.JsonQueryOnCallTableWithStringTypeColumnOperation;
    /**
