 ...
 */
export const CreateBarInsightFromCallTableDtoGroupBy = {
...
export type CreateBarInsightFromCallTableDtoGroupBy =
    (typeof CreateBarInsightFromCallTableDtoGroupBy)[keyof typeof CreateBarInsightFromCallTableDtoGroupBy];
