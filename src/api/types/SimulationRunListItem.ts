...
export interface SimulationRunListItem {
    ...
    status: Vapi.SimulationRunListItemStatus;
    ...
    simulations: Vapi.SimulationRunListItemSimulationsItem[];
    /** Target to test against */
    target: Vapi.SimulationRunListItemTarget;
    ...
    summary: Vapi.SimulationRunListSummary;
}
