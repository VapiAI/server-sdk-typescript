 ...
 */
export const PieInsightFromCallTableGroupBy = {
...
export type PieInsightFromCallTableGroupBy =
    (typeof PieInsightFromCallTableGroupBy)[keyof typeof PieInsightFromCallTableGroupBy];
