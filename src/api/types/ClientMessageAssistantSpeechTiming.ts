...
import type { AssistantSpeechWordAlignmentTiming } from "./AssistantSpeechWordAlignmentTiming.js";
import type { AssistantSpeechWordProgressTiming } from "./AssistantSpeechWordProgressTiming.js";
...
export type ClientMessageAssistantSpeechTiming =
    | ClientMessageAssistantSpeechTiming.WordAlignment
    | ClientMessageAssistantSpeechTiming.WordProgress;

export namespace ClientMessageAssistantSpeechTiming {
    export interface WordAlignment extends AssistantSpeechWordAlignmentTiming {
        type: "word-alignment";
    }

    export interface WordProgress extends AssistantSpeechWordProgressTiming {
        type: "word-progress";
    }
}
