...
export type CreateAssistantDtoTranscriber =
    | Vapi.CreateAssistantDtoTranscriber.AssemblyAi
    | Vapi.CreateAssistantDtoTranscriber.Azure
    | Vapi.CreateAssistantDtoTranscriber.CustomTranscriber
    | Vapi.CreateAssistantDtoTranscriber.Deepgram
    | Vapi.CreateAssistantDtoTranscriber._11Labs
    | Vapi.CreateAssistantDtoTranscriber.Gladia
    | Vapi.CreateAssistantDtoTranscriber.Google
    | Vapi.CreateAssistantDtoTranscriber.Speechmatics
