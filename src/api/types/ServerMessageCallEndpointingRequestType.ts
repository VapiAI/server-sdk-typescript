 ...
 * }
 */
export const ServerMessageCallEndpointingRequestType = {
    CallEndpointingRequest: "call.endpointing.request",
} as const;
export type ServerMessageCallEndpointingRequestType =
    (typeof ServerMessageCallEndpointingRequestType)[keyof typeof ServerMessageCallEndpointingRequestType];
