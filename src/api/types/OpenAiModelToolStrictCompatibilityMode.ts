 ...
 */
export const OpenAiModelToolStrictCompatibilityMode = {
    StripParametersWithUnsupportedValidation: "strip-parameters-with-unsupported-validation",
    StripUnsupportedValidation: "strip-unsupported-validation",
} as const;
export type OpenAiModelToolStrictCompatibilityMode =
    (typeof OpenAiModelToolStrictCompatibilityMode)[keyof typeof OpenAiModelToolStrictCompatibilityMode];
