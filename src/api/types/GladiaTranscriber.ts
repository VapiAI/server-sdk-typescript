...
import type { GladiaTranscriberLanguage } from "./GladiaTranscriberLanguage.js";
import type { GladiaTranscriberLanguageBehaviour } from "./GladiaTranscriberLanguageBehaviour.js";
import type { GladiaTranscriberLanguages } from "./GladiaTranscriberLanguages.js";
import type { GladiaTranscriberModel } from "./GladiaTranscriberModel.js";
import type { GladiaTranscriberRegion } from "./GladiaTranscriberRegion.js";

export interface GladiaTranscriber {
    /** This is the Gladia model that will be used. Default is 'fast' */
    model?: GladiaTranscriberModel | undefined;
    /** Defines how the transcription model detects the audio language. Default value is 'automatic single language'. */
    languageBehaviour?: GladiaTranscriberLanguageBehaviour | undefined;
    /** Defines the language to use for the transcription. Required when languageBehaviour is 'manual'. */
    language?: GladiaTranscriberLanguage | undefined;
    /** Defines the languages to use for the transcription. Required when languageBehaviour is 'manual'. */
    languages?: GladiaTranscriberLanguages | undefined;
    /**
    ...
    region?: GladiaTranscriberRegion | undefined;
