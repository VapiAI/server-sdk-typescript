...
import type { MinimaxVoiceLanguageBoost } from "./MinimaxVoiceLanguageBoost.js";
import type { MinimaxVoiceModel } from "./MinimaxVoiceModel.js";
import type { MinimaxVoiceRegion } from "./MinimaxVoiceRegion.js";
import type { MinimaxVoiceSubtitleType } from "./MinimaxVoiceSubtitleType.js";
...
export interface MinimaxVoice {
     ...
     */
    model?: MinimaxVoiceModel | undefined;
    /**
     ...
     * @default "sentence"
     */
    subtitleType?: MinimaxVoiceSubtitleType | undefined;
    /**
    ...
    region?: MinimaxVoiceRegion | undefined;
    /** Language hint for MiniMax T2A. Example: yue (Cantonese), zh (Chinese), en (English). */
    languageBoost?: MinimaxVoiceLanguageBoost | undefined;
