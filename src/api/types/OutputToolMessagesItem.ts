...
export type OutputToolMessagesItem =
    | Vapi.OutputToolMessagesItem.RequestStart
    | Vapi.OutputToolMessagesItem.RequestComplete
    | Vapi.OutputToolMessagesItem.RequestFailed
    | Vapi.OutputToolMessagesItem.RequestResponseDelayed;
