...
export type ToolDraftMessagesItem =
    | Vapi.ToolDraftMessagesItem.RequestStart
    | Vapi.ToolDraftMessagesItem.RequestComplete
    | Vapi.ToolDraftMessagesItem.RequestFailed
    | Vapi.ToolDraftMessagesItem.RequestResponseDelayed;

export namespace ToolDraftMessagesItem {
