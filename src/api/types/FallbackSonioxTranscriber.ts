...
import type { FallbackSonioxTranscriberLanguage } from "./FallbackSonioxTranscriberLanguage.js";
import type { FallbackSonioxTranscriberModel } from "./FallbackSonioxTranscriberModel.js";

export interface FallbackSonioxTranscriber {
    /** The Soniox model to use for transcription. */
    model?: FallbackSonioxTranscriberModel | undefined;
    /** The language for transcription. Uses ISO 639-1 codes. Soniox supports 60+ languages with a single universal model. */
    language?: FallbackSonioxTranscriberLanguage | undefined;
