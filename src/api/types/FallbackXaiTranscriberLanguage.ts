...
export const FallbackXaiTranscriberLanguage = {
    Ar: "ar",
    Cs: "cs",
    Da: "da",
    Nl: "nl",
...
export type FallbackXaiTranscriberLanguage =
    (typeof FallbackXaiTranscriberLanguage)[keyof typeof FallbackXaiTranscriberLanguage];
