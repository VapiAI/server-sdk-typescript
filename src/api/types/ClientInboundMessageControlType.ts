 ...
 */
export const ClientInboundMessageControlType = {
    Control: "control",
} as const;
export type ClientInboundMessageControlType =
    (typeof ClientInboundMessageControlType)[keyof typeof ClientInboundMessageControlType];
