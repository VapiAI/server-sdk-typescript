 ...
 */
export const AssistantCustomEndpointingRuleType = {
    Assistant: "assistant",
} as const;
export type AssistantCustomEndpointingRuleType =
    (typeof AssistantCustomEndpointingRuleType)[keyof typeof AssistantCustomEndpointingRuleType];
