...
export type CreateStructuredOutputDtoModel =
    | Vapi.CreateStructuredOutputDtoModel.Openai
    | Vapi.CreateStructuredOutputDtoModel.Anthropic
    | Vapi.CreateStructuredOutputDtoModel.AnthropicBedrock
    | Vapi.CreateStructuredOutputDtoModel.Google
    | Vapi.CreateStructuredOutputDtoModel.CustomLlm;
