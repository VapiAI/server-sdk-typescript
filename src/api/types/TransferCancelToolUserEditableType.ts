...
export const TransferCancelToolUserEditableType = {
    TransferCancel: "transferCancel",
} as const;
export type TransferCancelToolUserEditableType =
    (typeof TransferCancelToolUserEditableType)[keyof typeof TransferCancelToolUserEditableType];
