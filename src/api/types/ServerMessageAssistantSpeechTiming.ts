 ...
 */
export type ServerMessageAssistantSpeechTiming =
    | ServerMessageAssistantSpeechTiming.WordAlignment
    | ServerMessageAssistantSpeechTiming.WordProgress;

export namespace ServerMessageAssistantSpeechTiming {
