 ...
 * ```
 */
export const ServerMessageVoiceRequestType = {
    VoiceRequest: "voice-request",
} as const;
export type ServerMessageVoiceRequestType =
    (typeof ServerMessageVoiceRequestType)[keyof typeof ServerMessageVoiceRequestType];
