...
export type WorkflowVoice =
    | Vapi.WorkflowVoice.Azure
    | Vapi.WorkflowVoice.Cartesia
    | Vapi.WorkflowVoice.CustomVoice
    | Vapi.WorkflowVoice.Deepgram
    | Vapi.WorkflowVoice._11Labs
    | Vapi.WorkflowVoice.Hume
    | Vapi.WorkflowVoice.Lmnt
    | Vapi.WorkflowVoice.Neuphonic
    | Vapi.WorkflowVoice.Openai
    | Vapi.WorkflowVoice.Playht
    | Vapi.WorkflowVoice.Wellsaid
    | Vapi.WorkflowVoice.RimeAi
    | Vapi.WorkflowVoice.SmallestAi
    | Vapi.WorkflowVoice.Tavus
    | Vapi.WorkflowVoice.Vapi
    | Vapi.WorkflowVoice.Sesame
    | Vapi.WorkflowVoice.Inworld
    | Vapi.WorkflowVoice.Minimax
    | Vapi.WorkflowVoice.Xai
    | Vapi.WorkflowVoice.Microsoft;
