...
export type SmsToolMessagesItem =
    | Vapi.SmsToolMessagesItem.RequestStart
    | Vapi.SmsToolMessagesItem.RequestComplete
    | Vapi.SmsToolMessagesItem.RequestFailed
    | Vapi.SmsToolMessagesItem.RequestResponseDelayed;
