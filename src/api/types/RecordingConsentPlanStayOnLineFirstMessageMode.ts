 ...
 */
export const RecordingConsentPlanStayOnLineFirstMessageMode = {
    AssistantSpeaksFirst: "assistant-speaks-first",
    AssistantWaitsForUser: "assistant-waits-for-user",
} as const;
export type RecordingConsentPlanStayOnLineFirstMessageMode =
    (typeof RecordingConsentPlanStayOnLineFirstMessageMode)[keyof typeof RecordingConsentPlanStayOnLineFirstMessageMode];
