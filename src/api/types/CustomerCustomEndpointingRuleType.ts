 ...
 */
export const CustomerCustomEndpointingRuleType = {
    Customer: "customer",
} as const;
export type CustomerCustomEndpointingRuleType =
    (typeof CustomerCustomEndpointingRuleType)[keyof typeof CustomerCustomEndpointingRuleType];
