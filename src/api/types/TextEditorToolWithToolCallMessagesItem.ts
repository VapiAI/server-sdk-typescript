...
export type TextEditorToolWithToolCallMessagesItem =
    | Vapi.TextEditorToolWithToolCallMessagesItem.RequestStart
    | Vapi.TextEditorToolWithToolCallMessagesItem.RequestComplete
    | Vapi.TextEditorToolWithToolCallMessagesItem.RequestFailed
    | Vapi.TextEditorToolWithToolCallMessagesItem.RequestResponseDelayed;
