...
export type McpToolMessagesItem =
    | Vapi.McpToolMessagesItem.RequestStart
    | Vapi.McpToolMessagesItem.RequestComplete
    | Vapi.McpToolMessagesItem.RequestFailed
    | Vapi.McpToolMessagesItem.RequestResponseDelayed;
