 ...
 */
export const UpdatePieInsightFromCallTableDtoGroupBy = {
...
export type UpdatePieInsightFromCallTableDtoGroupBy =
    (typeof UpdatePieInsightFromCallTableDtoGroupBy)[keyof typeof UpdatePieInsightFromCallTableDtoGroupBy];
