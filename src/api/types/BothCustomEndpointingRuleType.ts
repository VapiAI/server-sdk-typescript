 ...
 */
export const BothCustomEndpointingRuleType = {
    Both: "both",
} as const;
export type BothCustomEndpointingRuleType =
    (typeof BothCustomEndpointingRuleType)[keyof typeof BothCustomEndpointingRuleType];
