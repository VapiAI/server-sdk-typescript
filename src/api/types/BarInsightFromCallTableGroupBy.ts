 ...
 */
export const BarInsightFromCallTableGroupBy = {
...
export type BarInsightFromCallTableGroupBy =
    (typeof BarInsightFromCallTableGroupBy)[keyof typeof BarInsightFromCallTableGroupBy];
