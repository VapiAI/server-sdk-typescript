...
export type ConversationNodeTranscriber =
    | Vapi.ConversationNodeTranscriber.AssemblyAi
    | Vapi.ConversationNodeTranscriber.Azure
    | Vapi.ConversationNodeTranscriber.CustomTranscriber
    | Vapi.ConversationNodeTranscriber.Deepgram
    | Vapi.ConversationNodeTranscriber._11Labs
    | Vapi.ConversationNodeTranscriber.Gladia
    | Vapi.ConversationNodeTranscriber.Google
    | Vapi.ConversationNodeTranscriber.Speechmatics
