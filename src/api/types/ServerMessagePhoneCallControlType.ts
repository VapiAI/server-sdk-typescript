 ...
 */
export const ServerMessagePhoneCallControlType = {
    PhoneCallControl: "phone-call-control",
} as const;
export type ServerMessagePhoneCallControlType =
    (typeof ServerMessagePhoneCallControlType)[keyof typeof ServerMessagePhoneCallControlType];
