...
import type { ServerMessageModelOutputPhoneNumber } from "./ServerMessageModelOutputPhoneNumber.js";
import type { ServerMessageModelOutputType } from "./ServerMessageModelOutputType.js";

export interface ServerMessageModelOutput {
    /** This is the phone number that the message is associated with. */
    phoneNumber?: ServerMessageModelOutputPhoneNumber | undefined;
    /** This is the type of the message. "model-output" is sent as the model outputs tokens. */
    type: ServerMessageModelOutputType;
    /**
