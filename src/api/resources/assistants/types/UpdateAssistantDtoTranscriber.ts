...
export type UpdateAssistantDtoTranscriber =
    | Vapi.UpdateAssistantDtoTranscriber.AssemblyAi
    | Vapi.UpdateAssistantDtoTranscriber.Azure
    | Vapi.UpdateAssistantDtoTranscriber.CustomTranscriber
    | Vapi.UpdateAssistantDtoTranscriber.Deepgram
    | Vapi.UpdateAssistantDtoTranscriber._11Labs
    | Vapi.UpdateAssistantDtoTranscriber.Gladia
    | Vapi.UpdateAssistantDtoTranscriber.Google
    | Vapi.UpdateAssistantDtoTranscriber.Speechmatics
